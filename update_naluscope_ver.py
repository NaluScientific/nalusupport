...
def update_naluscope_manual_version(new_version):
    ...
    for board in config.keys():
        if 'current' in config[board]:
            # Move the NaluScope manual in current to the archived section
            ...
            new_manual_entry = {
                ...
                'url': f'https://github.com/NaluScientific/NaluScope-Release/releases/download/{new_version}/NaluScope.{new_version[1:]}.User.Manual.pdf'
            }
